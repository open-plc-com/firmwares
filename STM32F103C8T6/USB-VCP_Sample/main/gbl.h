...
#define CLI					"\r\nW1> "							// Cli prompt
#define DEV_TYPE			20000								// Device type
...
static volatile uint16_t	ADC_PL_VALUES[ADC_PL_ARRAY_SIZE];
//static volatile uint32_t	ADC_PL_RES;
//static volatile uint32_t	PL_Min, PL_Cnt, PL_Min_Cnt, PL_Min_Nn, PL_Max1, PL_Max2;
static volatile uint32_t	PL_Cnt;
static volatile uint32_t	PL_Cur_Nn;
static volatile uint32_t	PL_Cur_Cnt_Min;
static volatile uint32_t	PL_Cur_Cnt_Max;
static volatile uint32_t	PL_Cur_I;
static volatile uint32_t	PL_Min[PL_NN];
static volatile uint32_t	PL_Min_Nn[PL_NN];
static volatile uint32_t	PL_Max[PL_NN];
static volatile uint32_t	PL_Max_Nn[PL_NN];
static volatile uint32_t	PL_Status;	// 0-Listen; 1-Rx; 2-Tx

/*
struct Port_In_Use_Struct
{
char	Port_Name;
uint16_t	Port_Nn;
};

struct Port_Use_Struct Port_In_Use[] =
{
'0',1,
'A',2,
'B',3,
